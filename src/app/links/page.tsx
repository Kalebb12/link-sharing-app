...
const LinksPage = () => {
  return (
    <div>
      <Navbar />
      <div id="screen" className="flex  gap-6 sm:p-6 p-4 sm:pt-0 justify-center max-w">
        <Mobile />
        <div className="flex flex-col flex-grow">
          <div className="flex flex-col gap-10 bg-[--white] sm:p-10 p-[24px] border-b rounded-xl rounded-b-none">
            <div>
              <h1 className="font-bold sm:text-[32px] text-[24px]">Customize your links</h1>
              <span>
            ...
            <div className="flex flex-col gap-6">
              <button className="w-full rounded-lg border border-[--purple] text-[--purple] px-[27px] py-[11px] hover:bg-[--purple-light]">
                + Add new link
              </button>
              <div className="flex flex-col items-center gap-10 bg-[--light-gray] p-5">
                ...
                <div className="text-center sm:max-w-[488px] max-w-[255px]">
                  <h1 className="font-bold sm:text-[32px] text-[24px]">Let’s get you started</h1>
